...
public class LiquidMeds extends Medicine implements ISellable{
	...
	public LiquidMeds(String name, String expiryDate, double price, int quantity, double totalPrice, double discount, String stockAdjustments) {
